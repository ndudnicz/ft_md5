...
hash_this(uint8_t *const data, t_opt *const options) {
	...
	for (uint64_t offset = 0; offset < options->new_size / 4; offset += 16) {
		...
		STEP0_15(tmp, 3, f, g, a, b, c, d, k, w, r)
		STEP0_15(tmp, 4, f, g, a, b, c, d, k, w, r)
		STEP0_15(tmp, 5, f, g, a, b, c, d, k, w, r)
		STEP0_15(tmp, 6, f, g, a, b, c, d, k, w, r)
		STEP0_15(tmp, 7, f, g, a, b, c, d, k, w, r)
		STEP0_15(tmp, 8, f, g, a, b, c, d, k, w, r)
		STEP0_15(tmp, 9, f, g, a, b, c, d, k, w, r)
